...
│   └── config_NNNN.json   Random configs generated by htm_generate_configs.py
│
...
> are written to the project root or its subdirectories (`models/`, `plots/`, `results/`).
...
Parses raw keystroke `.txt` files, extracts 14-dim feature windows, generates
...
Example:
```
cfg0023_sp40_enc32w5_tm32_act13_vf10.8571_tf10.8200
```
