...
# --- CONFIGURATION ---
CSV_FILE = "balanced_dataset.csv"
MODEL_SAVE_PATH = "badusb_model.pth"
SCALER_SAVE_PATH = "scaler_params.npy" # Need to save scaler parameters for production!
...
def prepare_data():
    ...
    # Split Temp: 15% Val (this is 0.75 of 20%), 5% Test (this is 0.25 of 20%)
    ...
    X_val = scaler.transform(X_val)         # Apply to Val
    X_test = scaler.transform(X_test)       # Apply to Test
    
    # Save scaler parameters (mean and variance) for later use in the application
