...
Outputs:
  configs/config_0000.json … config_NNNN.json
...
# config_0000 is always the current "default" from HTM_training.py
DEFAULT_CONFIG = {
    "sp_columnDimensions":   2048,
...
python htm_train_single.py --config "$CONFIG"
"""
...
def main():
    ...
    print(f"\nWorkflow:")
    print(f"  1. python prepare_data.py           # once, on login node")
    print(f"  2. sbatch slurm/submit_array.sh     # submit {len(configs)} jobs")
    print(f"  3. python collect_results.py        # after all jobs finish")
