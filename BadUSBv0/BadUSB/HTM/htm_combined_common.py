...
# Adjusting project root for BadUSBv0 structure
_badusb_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) # BadUSBv0/BadUSB
_project_root = os.path.dirname(os.path.dirname(_badusb_root)) # C:/technion/HWSecurity/BadUSBDetect_attempt1

if _project_root not in sys.path:
    sys.path.insert(0, _project_root)

# Assuming common and htm_distance are at the project root level
_common_dir = os.path.join(_project_root, "common")
if _common_dir not in sys.path:
    sys.path.insert(0, _common_dir)

_htm_distance_dir = os.path.join(_project_root, "htm_distance")
if _htm_distance_dir not in sys.path:
    sys.path.insert(0, _htm_distance_dir)
