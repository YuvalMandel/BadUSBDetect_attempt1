...
def write_slurm_script(n_configs: int, out_path: str, configs_dir: str):
    script = f"""\
#!/bin/bash
...
#
# Submit with:
#   sbatch {os.path.basename(out_path)}
#
...
mapfile -t CONFIGS < <(ls {configs_dir}/config_*.json | sort)
...
def main():
    ...
    write_slurm_script(n, slurm_script_path, os.path.relpath(configs_dir, os.path.join(slurm_dir, "..", "BadUSBv0", "BadUSB")))
