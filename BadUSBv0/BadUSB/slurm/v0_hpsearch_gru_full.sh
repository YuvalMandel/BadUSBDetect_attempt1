...
#   cd BadUSBv0/BadUSB && sbatch slurm/v0_hpsearch_gru_full.sh
# ============================================================
#SBATCH --job-name=v0_gru_hpsearch
#SBATCH --output=logs/v0_gru_hpsearch_%j.out
#SBATCH --error=logs/v0_gru_hpsearch_%j.err
